...
export default function ProductMen() {
  ...
  return (
    <>
      <p className="relative p-1 my-4 text-2xl font-bold text-center">MEN Products
      ...
      <div className="grid grid-cols-2 gap-4 p-4 sm:grid-cols-4 w-[100%] md:w-[80%] md:h-[100%] text-xs md:justify-end   font-popins bg-white md:px-10 md:text-lg">
        {menData?.map((product) => (
          <Link to={`/product-detail/${product.id}`} key={product.id}>
            ...
            <div className="flex">
              ...
              <p className="px-1  text-gray-700 line-through text-[#737373]">₹{product.price}</p>
            </div>
