...
export function Temscondition() {
  return (
    <div className="max-w-4xl mx-auto p-8 bg-gray-100 rounded-lg shadow-md">
      <h1 className="text-3xl font-bold mb-6">Terms and Conditions</h1>

      <p className="mb-4">
        Welcome to <strong>Shamaim.in</strong>! These terms and conditions outline the rules and regulations for the use of{' '}
        <strong>SHAMAIM LIFESTYLE's Website</strong>, located at{' '}
        <a href="https://shamaim.in/" className="text-blue-500 hover:underline">
          shamaim.in
        </a>
        .
      </p>
      ...
      <p className="mb-4">
        By accessing this website, we assume you accept these terms and conditions. Do not continue to use <strong>Shamaim.in</strong> if
      ...
      <p className="mb-4">
        ...
        provision of the Company's stated services, in accordance with and subject to, prevailing law of in. Any use of the above
      ...
      <p className="mb-4">
        We employ the use of cookies. By accessing <strong>Shamaim.in</strong>, you agreed to use cookies in agreement with the{' '}
        <strong>SHAMAIM LIFESTYLE's Privacy Policy</strong>.
      </p>
      ...
      <p className="mb-4">
        Unless otherwise stated, SHAMAIM LIFESTYLE and/or its licensors own the intellectual property rights for all material on
        Shamaim.in. All intellectual property rights are reserved. You may access this from Shamaim.in for your own personal use
      ...
      <ul className="list-disc pl-8 mb-4">
        <li>Republish material from Shamaim.in</li>
        <li>Sell, rent or sub-license material from Shamaim.in</li>
        <li>Reproduce, duplicate or copy material from Shamaim.in</li>
        <li>Redistribute content from Shamaim.in</li>
      </ul>

      <p className="mb-4">
        This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the Free Terms and
        Conditions Generator.
      </p>

      <h2 className="text-2xl font-bold mb-2">Comments Policy</h2>
      ...
      <p className="mb-4">
        ...
        website. SHAMAIM LIFESTYLE does not filter, edit, publish or review Comments prior to their presence on the website. Comments
        do not reflect the views and opinions of SHAMAIM LIFESTYLE, its agents, and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by applicable laws, SHAMAIM LIFESTYLE shall
        not be liable for the Comments or for any liability, damages, or expenses caused and/or suffered as a result of any use of
        and/or posting of and/or appearance of the Comments on this website.
      </p>

      <p className="mb-4">
        SHAMAIM LIFESTYLE reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li>The Comments do not invade any intellectual property right, including without limitation copyright, patent or trademark of
          any third party;</li>
        <li>The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material which is an
      ...
      <p className="mb-4">
        You hereby grant SHAMAIM LIFESTYLE a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and
      ...
      <ol className="list-decimal pl-8 mb-4">
        ...
        <li>the benefit to us from the visibility of the hyperlink compensates the absence of SHAMAIM LIFESTYLE; and</li>
      ...
      <p className="mb-4">
        ...
        by sending an e-mail to SHAMAIM LIFESTYLE. Please include your name, your organization name, contact information as well as the
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li>By use of any other description of our Website being linked to that makes sense within the context and format of content on
          the linking party's site.</li>
      </ul>

      <p className="mb-4">
        No use of SHAMAIM LIFESTYLE's logo or other artwork will be allowed for linking absent a trademark license agreement.
      </p>
      ...
      <p className="mb-4">
        If you find any link on our Website that is offensive for any reason, you are free to contact and inform us at any moment. We
