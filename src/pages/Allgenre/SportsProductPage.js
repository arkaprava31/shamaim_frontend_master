...
import { fetchProductsSportsAsync } from './GenereSlice';
import { useState, Fragment, useEffect } from 'react';
import { useSelector, useDispatch } from 'react-redux';
import Footer from '../../features/common/Footer'
const SportsProductPage = ({ products, status }) => {
  ...
  const responce=await dispatch(fetchProductsSportsAsync({filter, sort, pagination,  }));
  ...
  return (
    <div>
        <img src="https://firebasestorage.googleapis.com/v0/b/shamaim-lifestyle.appspot.com/o/Homejonnerbox%2FSports.png?alt=media&token=9857f2eb-2e39-4f64-932e-74212fa0966f"
         alt="sportProduct" />
